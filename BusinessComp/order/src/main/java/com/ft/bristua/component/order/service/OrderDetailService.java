...
import com.ft.bristua.component.order.wrapper.OrderDetailReslut;
...
public class OrderDetailService {
    ...
    public static void detail(@NonNull OrderCancelWrapper pWrapper, @NonNull final IFlutterResult pResult) {
        ...
        Disposable disposable = restApi.detail(pWrapper.getOrderId())
                ...
                .subscribe(new Consumer<String>() {
                    ...
                    public void accept(String result) {
                        ...
                        if (TextUtils.isEmpty(result)) {
                            ...
                            OrderDetailReslut orderDetailReslut = JSON.parseObject(result, OrderDetailReslut.class);
                            flutterResult = ProtocolFactory.convertToJson("", 200, orderDetailReslut);
                        }
                        //todo zyb 尝试看下情况是否靠谱
