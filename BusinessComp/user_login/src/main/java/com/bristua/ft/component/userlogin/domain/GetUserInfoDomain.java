...
import com.bristua.ft.component.userlogin.service.GetUserInfoService;
 ...
 * smsCode层
 */
public class GetUserInfoDomain implements IDomain {
    @Override
    public void execute(@NonNull IEntity iEntity, @NonNull IFlutterResult pFlutterResult) {
        GetUserInfoService.getUserInfo(pFlutterResult);
    }
}
