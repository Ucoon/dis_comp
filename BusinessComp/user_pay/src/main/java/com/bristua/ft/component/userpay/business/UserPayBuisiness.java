 ...
 * @author richsjeson
 */
public class UserPayBuisiness extends BaseBusiness implements IBusinessManager {

    public UserPayBuisiness(@NonNull String pMobule) {
        super(pMobule);
    }
    ...
    public void execute(@NonNull String pProtocol, @NonNull IFlutterResult pResult) {
        ...
        IEntity entity = UserPayRepository.getFactory().getEntity(method);
